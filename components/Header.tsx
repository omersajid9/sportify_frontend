            ...
            {user ?
                <View className="flex-row items-center gap-4">
                    ...
                    <TouchableOpacity className="" onPress={() => router.navigate("/settings")}>
                        <Ionicons name="settings" size={30} color="rgb(30 58 138)" />
                    </TouchableOpacity>
                    {/* <View> */}
                </View>
                :
                <View className="flex-row items-center">
                    <Pressable className='py-1 h-9' onPress={() => SheetManager.show("authsheet")}>
...
export function HomeHeader() {
    ...
    return (
        ...
        <View className="flex-row items-center justify-between px-4 py-3 bg-transparent  rounded-lg mx-2 shadow-lg shadow-neutral-400">
            <View className="flex-row items-center justify-center">
            </View>
